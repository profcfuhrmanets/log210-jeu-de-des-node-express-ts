...
- [Travail d'équipe](#travail-déquipe)
  ...
  - [Plan d'itération](#plan-ditération)
    ...
    - [Lien intéressant pour planifier vos itérations](#lien-intéressant-pour-planifier-vos-itérations)
  ...
  - [Grilles de correction](#grilles-de-correction)
    - [Critéres appliqués au plan d'itération](#critéres-appliqués-au-plan-ditération)
    - [Critères appliqué au rapport](#critères-appliqué-au-rapport)
    - [Critères appliqués aux artéfacts de conception du rapport](#critères-appliqués-aux-artéfacts-de-conception-du-rapport)
...
- Itération 3 - 4 points additionnels
...
Le travail de laboratoire sera évalué en deux volets, soit la partie **rapport et planification** et la partie **implémentation et tests.**
...
- CU07 - Faire vidéo pour la démonstration technique avec les testss
- Réviser CU07
...
### Lien intéressant pour planifier vos itérations
...
### Critéres appliqués au plan d'itération
...
### Critères appliqués aux artéfacts de conception du rapport
